...
# Form implementation generated from reading ui file '/home/yeison/Documentos/Desarrollo/Pinguino/GitHub/pinguino-ide/pinguino/qtgui/frames/select_area.ui'
#
...
class Ui_Selection(object):
    def setupUi(self, Selection):
        ...
        self.border_w = QtWidgets.QFrame(Selection)
        ...
        self.horizontalLayout_7 = QtWidgets.QHBoxLayout(self.border_w)
        self.horizontalLayout_7.setSpacing(0)
        self.horizontalLayout_7.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_7.setObjectName("horizontalLayout_7")
        self.gridLayout.addWidget(self.border_w, 1, 0, 1, 1)
        self.background = QtWidgets.QFrame(Selection)
        ...
        self.border_e = QtWidgets.QFrame(Selection)
        ...
        self.horizontalLayout_9 = QtWidgets.QHBoxLayout(self.border_e)
        self.horizontalLayout_9.setSpacing(0)
        self.horizontalLayout_9.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_9.setObjectName("horizontalLayout_9")
        self.gridLayout.addWidget(self.border_e, 1, 2, 1, 1)
        self.border_n = QtWidgets.QFrame(Selection)
        ...
        self.horizontalLayout_11 = QtWidgets.QHBoxLayout(self.border_n)
        self.horizontalLayout_11.setSpacing(0)
        self.horizontalLayout_11.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_11.setObjectName("horizontalLayout_11")
        self.gridLayout.addWidget(self.border_n, 0, 0, 1, 3)
        self.border_s = QtWidgets.QFrame(Selection)
        ...
        self.horizontalLayout_5 = QtWidgets.QHBoxLayout(self.border_s)

...
class Ui_About(object):
    def setupUi(self, About):
        ...
        spacerItem = QtWidgets.QSpacerItem(620, 20, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        self.gridLayout.addItem(spacerItem, 5, 0, 1, 3)
        spacerItem1 = QtWidgets.QSpacerItem(620, 20, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        self.gridLayout.addItem(spacerItem1, 3, 0, 1, 3)
        self.gridLayout_4 = QtWidgets.QGridLayout()
        self.gridLayout_4.setObjectName("gridLayout_4")
        self.pushButton_credits = QtWidgets.QPushButton(self.page)
        ...
        self.pushButton_close = QtWidgets.QPushButton(self.page)
        ...
        self.pushButton_license = QtWidgets.QPushButton(self.page_2)
        ...
        self.pushButton_close_2 = QtWidgets.QPushButton(self.page_2)
...
"the Free Software Foundation, Inc., 59 Temple Place, Suite 330, Boston, MA  02111-1307  USA")
    ...
    def retranslateUi(self, About):
        About.setWindowTitle(QtWidgets.QApplication.translate("About", "About...", None))
        self.label_3.setText(QtWidgets.QApplication.translate("About", "<html><head/><body><p align=\"center\">Pinguino is an Open Software and Open Hardware<br>Arduino-like project. Boards are based on 8 or 32-bit USB built-in<br>Microchip microcontrollers. The main goal is to build a real<br>USB system without USB to serial converter.</p></body></html>", None))
        self.pushButton_credits.setText(QtWidgets.QApplication.translate("About", "Credits", None))
        self.pushButton_close.setText(QtWidgets.QApplication.translate("About", "Close", None))
        self.label_9.setText(QtWidgets.QApplication.translate("About", "Credits", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), QtWidgets.QApplication.translate("About", "Write by", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), QtWidgets.QApplication.translate("About", "Docummented by", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), QtWidgets.QApplication.translate("About", "Translated by", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_4), QtWidgets.QApplication.translate("About", "Art by", None))
        self.pushButton_license.setText(QtWidgets.QApplication.translate("About", "License", None))
        self.pushButton_close_2.setText(QtWidgets.QApplication.translate("About", "Close", None))
        self.pushButton_close_3.setText(QtWidgets.QApplication.translate("About", "Close", None))
        self.pushButton_about.setText(QtWidgets.QApplication.translate("About", "About", None))
        self.label_8.setText(QtWidgets.QApplication.translate("About", "License", None))
